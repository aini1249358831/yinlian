...
public class QueryServiceImpl {
    ...
    public String[] query(HttpServletRequest req, HttpServletResponse resp) {
        ...
        /***商户接入参数***/
        data.put("merId", "777290058166588");                  //商户号码，请改成自己申请的商户号或者open上注册得来的777商户号测试
        data.put("accessType", "0");                           //接入类型，商户接入固定填0，不需修改

        /***要调通交易以下字段必须修改***/
        data.put("orderId", "123456789");                 //****商户订单号，每次发交易测试需修改为被查询的交易的订单号
        ...
        strings[0] = reqMessage;
        strings[1] = rspMessage;
